  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
        <div className="flex flex-col border-1 rounded-2xl border-gray-700 bg-gray-800 shadow-2xl w-full max-w-4xl max-h-[90vh] text-white overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 overflow-y-auto grow bg-gray-900">
            <AdminPanelNav active={tab} onChange={setTab} />
            <div className="grow min-w-0 p-6">
